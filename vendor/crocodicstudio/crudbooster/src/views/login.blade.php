  ...
  <body class="login-page">
    ...
    <div class="login-box">
      <div class="login-logo">
        <a href="{{url('/')}}">
            <img title='{!!($appname == 'CRUDBooster')?"<b>Realhosting</b>Booster":$appname!!}' src='{{ get_setting("logo")?asset(get_setting('logo')):asset('vendor/crudbooster/assets/realhosting.png') }}' style='max-width: 100%;max-height:170px'/>
        </a>
      </div><!-- /.login-logo -->      
      <div class="login-box-body">
        ...
        <form autocomplete='off' action="{{ route('postLogin') }}" method="post">
          ...
          <div class="row">
            <div class="col-xs-12">                  
              <a class='btn btn-primary btn-block btn-flat' href='{{route("getRegister")}}'><i class='fa fa-user'></i> Registreer</a>          
            </div><!-- /.col -->
          </div>
          @endif
          
          <div class='row'>
            <div class='col-xs-12' align="center"><p style="padding:10px 0px 10px 0px">Wachtwoord vergeten ? <a href='{{route("getForgot")}}'>Klik hier</a>   </p></div>
          </div>
        </form>
