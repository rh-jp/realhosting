  ...
  <body class="lockscreen">
    ...
    <div class="lockscreen-wrapper">
      <div class="lockscreen-logo">
        <a href="{{url('/')}}">
            <img title='{!!($appname == 'CRUDBooster')?"<b>Realhosting</b>":$appname!!}' src='{{ get_setting("logo")?asset(get_setting('logo')):asset('vendor/crudbooster/assets/realhosting.png') }}' style='max-width: 100%;max-height:170px'/>
        </a>
      </div>
      <!-- User name -->
      ...
      <div class='text-center'>
        <a href="{{route("getLogout")}}">Of login als een andere gebruiker</a>
      </div>
      <div class='lockscreen-footer text-center'>
        Copyright <strong>Realhosting</strong> &copy; {{date("Y")}}<br>
