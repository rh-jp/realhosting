    ...
    <div class="lockscreen-wrapper">
      <div class="lockscreen-logo">
        <a href="<?php echo e(url('/')); ?>">
            <img title='<?php echo ($appname == 'CRUDBooster')?"<b>Realhosting</b>":$appname; ?>' src='<?php echo e(get_setting("logo")?asset(get_setting('logo')):asset('vendor/crudbooster/assets/realhosting.png')); ?>' style='max-width: 100%;max-height:170px'/>
        </a>
      </div>
      <!-- User name -->
      <div class="lockscreen-name"><?php echo e(Session::get('admin_name')); ?></div>

      <!-- START LOCK SCREEN ITEM -->
      <div class="lockscreen-item">
        <!-- lockscreen image -->
        <div class="lockscreen-image">
          <img src="<?php echo e((Session::get('admin_photo'))?:asset("assets/adminlte/dist/img/user2-160x160.jpg")); ?>" alt="user image"/>
        </div>
        <!-- /.lockscreen-image -->

        <!-- lockscreen credentials (contains the form) -->
        <form class="lockscreen-credentials" method='post' action="<?php echo e(url(config('crudbooster.ADMIN_PATH').'/unlock-screen')); ?>">
      ...
      <div class="text-center">
        Voer je wachtwoord in om je sessie te herstellen
      </div>
      <div class='text-center'>
        <a href="<?php echo e(route("getLogout")); ?>">Of login als een andere gebruiker</a>
      </div>
      <div class='lockscreen-footer text-center'>
        Copyright <strong>Realhosting</strong> &copy; <?php echo e(date("Y")); ?><br>
