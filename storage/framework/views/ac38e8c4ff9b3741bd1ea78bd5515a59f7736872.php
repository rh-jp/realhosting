...
<ul class="nav nav-tabs">
        ...
        <li class='active'><a href="<?php echo e(mainpath('generator')); ?>"><i class='fa fa-cog'></i> API Generator</a></li>        
      </ul>
                ...
                <form method='post' action='<?php echo e(route("ApiCustomControllerPostSaveApiCustom")); ?>'>
                  ...
                  <input type="hidden" name="id" value="<?php echo e($row->id); ?>">
                        ...
                        <div class='form-group'>
                            ...
                            <textarea name='keterangan' rows='3' class='form-control' placeholder='Optional'><?php echo e($row->keterangan); ?></textarea>
                        </div>
