    ...
    <section class="sidebar">
        ...
        <div class="user-panel">
            <div class="pull-left image">
                <img src="<?php echo e(get_my_photo()); ?>" style='height:50px;width:50px' class="img-circle" alt="User Image" />
            </div>
            <div class="pull-left info">
                <p><?php echo e(get_my_name()); ?></p>
                <!-- Status -->
                <a href="#"><i class="fa fa-circle text-success"></i> Online</a> • <a target="_blank" href="<?php echo e(url('/')); ?>">Visit FrontEnd</a>
            </div>
        </div>
        ...
        <script type="text/javascript">
            function add_statistic_datatable() {
                ...
                $("#modal_widget_statistic .modal-body").load("<?php echo e(route('AdminControllerGetSettingDatatable')); ?>",function() {
            ...
            function edit_statistic_datatable(id) {
                ...
                $("#modal_widget_statistic .modal-title").text("Datatable Setting");
                $("#modal_widget_statistic .modal-body").load("<?php echo e(route('AdminControllerGetSettingDatatable')); ?>/"+id,function() {
                    $("#modal_widget_statistic").modal("show");                                            
                });                
            }
            ...
            function add_statistic_donut() {
                ...
                $("#modal_widget_statistic .modal-body").load("<?php echo e(route('AdminControllerGetSettingChartDonut')); ?>",function() {
                    $("#modal_widget_statistic").modal("show");   
                });
            }
            ...
            function edit_statistic_donut(id) {
                ...
                $("#modal_widget_statistic .modal-title").text("Chart Donut Setting");
                $("#modal_widget_statistic .modal-body").load("<?php echo e(route('AdminControllerGetSettingChartDonut')); ?>/"+id,function() {
                    $("#modal_widget_statistic").modal("show");   
                });                
            }
             ...
             function add_statistic_bar() {
                ...
                $("#modal_widget_statistic .modal-body").load("<?php echo e(route('AdminControllerGetSettingChartBar')); ?>",function() {
                    $("#modal_widget_statistic").modal("show");   

                    $("#modal_widget_statistic select[name=table_name]").change(function() {
                        var table_name = $(this).val();
                        $.get("<?php echo e(route('AdminControllerGetSelectColumnTable')); ?>/"+table_name,function(resp) {
            ...
            function edit_statistic_bar(id) {
                ...
                $("#modal_widget_statistic .modal-title").text("Chart Bar Setting");
                $("#modal_widget_statistic .modal-body").load("<?php echo e(route('AdminControllerGetSettingChartBar')); ?>/"+id,function() {
                    $("#modal_widget_statistic").modal("show");   

                    $("#modal_widget_statistic select[name=table_name]").change(function() {
                        var table_name = $(this).val();
                        var current = $("#modal_widget_statistic select[name=column]").attr("data-current");
                        $.get("<?php echo e(route('AdminControllerGetSelectColumnTable')); ?>/"+table_name+"/"+current,function(resp) {
                            $("#modal_widget_statistic select[name=column]").html(resp);
                        })
                    })                      
            ...
            function add_statistic_line() {
                ...
                $("#modal_widget_statistic .modal-body").load("<?php echo e(route('AdminControllerGetSettingChartLine')); ?>",function() {
                    $("#modal_widget_statistic").modal("show");   
            ...
            function edit_statistic_line(id) {
                ...
                $("#modal_widget_statistic .modal-title").text("Chart Line Setting");
                $("#modal_widget_statistic .modal-body").load("<?php echo e(route('AdminControllerGetSettingChartLine')); ?>/"+id,function() {
                    $("#modal_widget_statistic").modal("show");   
            ...
            function add_statistic_number() {
                ...
                $("#modal_widget_statistic .modal-body").load("<?php echo e(route('AdminControllerGetSettingStatNumber')); ?>",function() {
                    $("#modal_widget_statistic").modal("show");    
            ...
            function edit_statistic_number(id) {
                ...
                $("#modal_widget_statistic .modal-title").text("Statistic Number Setting");
                $("#modal_widget_statistic .modal-body").load("<?php echo e(route('AdminControllerGetSettingStatNumber')); ?>/"+id,function() {
                    $("#modal_widget_statistic").modal("show");    
            ...
            $(function() {
                ...
                $("#modal_widget_statistic").on("submit","form",function() {
                    $.ajax({
                        ...
                        success:function(id) {
                            $.get("<?php echo e(route('AdminControllerGetStatisticDashboard')); ?>/"+id,function(html_widget) {
                ...
                $("#dashboard").on("click",".btn-delete-stat",function() {
                    ...
                    if(confirm("Are you sure want to delete ?")) {                        
                        $.get("<?php echo e(route('AdminControllerGetRemoveCmsDashboard')); ?>/"+id,function(resp) {
                            h.remove();
                        });
                    }
                })
            ...
            <div class='dashboard-config-menu'>
                <ul class='sidebar-menu'>
                    ...
                    <li><a href='<?php echo e(route("AdminControllerGetUnsetDashboardConfigMode")); ?>'><i class='fa fa-power-off'></i> <span>Back To Admin</span></a></li>
                </ul>
            </div>
        <?php else:?>
            <div class='main-menu'> 
            ...
            <ul class="sidebar-menu">
                ...
                <li ><a href="<?php echo e(route('AdminControllerGetIndex')); ?>"><i class='fa fa-dashboard'></i><span>Dashboard</span></a></li>
                ...
                ?>
                    <?php if($g->is_group==1): ?>
                        <li class="treeview <?=(count($moduls)==0)?'hide':''?>">
                            <a href="#"><i class='<?php echo e($g->icon_group); ?>'></i> <span><?php echo e($g->nama_group); ?></span> <i class="fa fa-angle-left pull-right"></i></a>
                            <ul class="treeview-menu">
                    <?php endif; ?>
                    ...
                    ?>            
                        <li class="<?=($modul->path==$current_path)?'active':''?>"><a href="<?php echo e(url(config('crudbooster.ADMIN_PATH').'/'.$modul->path)); ?>"><i class='<?=$modul->icon?>'></i><span><?=$modul->name?></span></a></li>
                    <?php endforeach;?>
