<?php $__env->startSection('content'); ?>	 
            ...
            <div class='row'>
              ...
              <?php foreach($group_setting as $g): ?>
                <div class='col-sm-12 group-col group-state'>
                  <!-- Box -->
                  <div id='box_main' class="box box-primary collapsed-box">
                      <div class="box-header with-border">
                          <h3 class="box-title"><i class='fa fa-cog'></i> <?php echo e($g); ?></h3> &nbsp;&nbsp;
                           <a title='Add New Setting' class='label label-primary' href='<?php echo e(mainpath("add?group_setting=$g")); ?>'><i class='fa fa-plus'></i> New Setting</a>
                          <div class="box-tools pull-right">
                            <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-plus"></i></button>
                            
                          </div>
                      </div>
      				        <form method='post' id="form" enctype="multipart/form-data" action='<?php echo e(mainpath("save-setting?group_setting=$g")); ?>'>
                          ...
                          <div class="box-body">
                                  ...
                                  <div class='form-group'>
                                      <label class='label-setting'><?php echo e($s->label); ?> 
                                          <a style="visibility:hidden" href='<?php echo e(mainpath("edit/$s->id")); ?>' title='Edit This Meta Setting' class='btn btn-box-tool'><i class='fa fa-pencil'></i></a> 
                                          <a style="visibility:hidden" href='javascript:;' title='Delete this Setting' class='btn btn-box-tool'
                                          onClick='swal({   title: "Are you sure?",   text: "You will not be able to recover <?php echo e($s->label); ?> and may be can cause some errors on your system !",   type: "warning",   showCancelButton: true,   confirmButtonColor: "#DD6B55",   confirmButtonText: "Yes, delete it!",   closeOnConfirm: false }, function(){  location.href="<?php echo e(mainpath("delete/$s->id")); ?>" });'
