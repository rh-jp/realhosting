...
<header class="main-header">
    ...
    <!-- Logo -->
    <a href="<?php echo e(url(config('crudbooster.ADMIN_PATH'))); ?>" class="logo"><?php echo e(get_setting('appname')); ?></a>
        ...
        <div class="navbar-custom-menu">
            ...
            <li class="dropdown notifications-menu">
                ...
                <ul id='list_notifications' class="dropdown-menu">
                  ...
                  <li class="footer"><a href="<?php echo e(route('NotificationsControllerGetIndex')); ?>">View all</a></li>
                </ul>
              </li>
                ...
                <li class="dropdown user user-menu">
                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <img src="<?php echo e(get_my_photo()); ?>" class="user-image" alt="User Image"/>
                        <!-- hidden-xs hides the username on small devices so only the image appears. -->
                        <span class="hidden-xs"><?php echo e(get_my_name()); ?></span>
                    </a>
                    <ul class="dropdown-menu">
                        <!-- The user image in the menu -->
                        <li class="user-header">
                            <img src="<?php echo e(get_my_photo()); ?>" class="img-circle" alt="User Image" />
                            <p>
                                <?php echo e(get_my_name()); ?>

                                <small><?php echo e(get_my_privilege_name()); ?></small>
                        ...
                        <li class="user-footer">
                            <div class="pull-left">
                                <a href="<?php echo e(route('UsersControllerGetProfile')); ?>" class="btn btn-default btn-flat"><i class='fa fa-user'></i> Profile</a>
                            </div>
                            <div class="pull-right">
                                ...
                                <a href="javascript:void(0)" onclick="swal({   
                                    ...
                                    text: 'Je moet weer opnieuw inloggen, of je kunt het scherm vergrendelen',   
                                    type:'info',   
